...
class War {
  ...
  vikingAttack() {
    ...
    const saxon = this.saxonArmy[randomNum];
    const viking = this.vikingArmy[randomNum];

    const comment = saxon.receiveDamage(viking.attack());
  ...
  saxonAttack() {
    ...
    const comment = viking.receiveDamage(saxon.attack());
